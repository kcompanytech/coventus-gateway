...
class EventBookingResponse
{
    ...
    public function __construct($data)
    {
       ...
       public function getStart() { return $this->convertTimestamp($this->start); }
       public function getEnd() { return $this->convertTimestamp($this->end); }
       
       public function getTitle() { return $this->title; }
       public function getInfo() { return $this->info; }
       public function getText() { return $this->text; }
       public function getBookedBy() { return $this->bookedBy; }
       public function getBookedByName() { return $this->bookedByName; }
       public function getLastEditedBy() { return $this->lastEditedBy; }
       public function getLastEditedByName() { return $this->lastEditedByName; }
       public function getBookedTo() { return $this->bookedTo; }
       public function getOrganizationalUnit() { return $this->organizationalUnit; }
       public function getPin() { return $this->pin; }
       public function getAccessControlUnlock() { return $this->accessControlUnlock; }
       public function getSerie() { return $this->serie; }
       public function getBookingType() { return $this->bookingType; }
       public function getBookingContext() { return $this->bookingContext; }
       public function getBookingGroups() { return $this->bookingGroups; }
       public function getMaxParticipants() { return $this->maxParticipants; }
       public function getGetEventEnabled() { return $this->getEventEnabled; }
       public function getGetEventImage() { return $this->getEventImage; }
       ...
       public function setBookedBy($bookedBy) { $this->bookedBy = $bookedBy; }
       public function setBookedByName($bookedByName) { $this->bookedByName = $bookedByName; }
       public function setLastEditedBy($lastEditedBy) { $this->lastEditedBy = $lastEditedBy; }
       public function setLastEditedByName($lastEditedByName) { $this->lastEditedByName = $lastEditedByName; }
       public function setBookedTo($bookedTo) { $this->bookedTo = $bookedTo; }
       public function setOrganizationalUnit($organizationalUnit) { $this->organizationalUnit = $organizationalUnit; }
       public function setPin($pin) { $this->pin = $pin; }
       public function setAccessControlUnlock($accessControlUnlock) { $this->accessControlUnlock = $accessControlUnlock; }
       public function setSerie($serie) { $this->serie = $serie; }
       public function setBookingType($bookingType) { $this->bookingType = $bookingType; }
       public function setBookingContext($bookingContext) { $this->bookingContext = $bookingContext; }
       public function setBookingGroups($bookingGroups) { $this->bookingGroups = $bookingGroups; }
       public function setMaxParticipants($maxParticipants) { $this->maxParticipants = $maxParticipants; }
       public function setGetEventEnabled($getEventEnabled) { $this->getEventEnabled = $getEventEnabled; }
       public function setGetEventImage($getEventImage) { $this->getEventImage = $getEventImage; }
       public function setRuleId($ruleId) { $this->ruleId = $ruleId; }
       public function setAttendance($attendance) { $this->attendance = $attendance; }
       public function setNumberOfGuests($numberOfGuests) { $this->numberOfGuests = $numberOfGuests; }
